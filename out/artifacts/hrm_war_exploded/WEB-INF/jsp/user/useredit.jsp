    ...
    <td>
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">姓&nbsp;名：<input type="text" name="username" value="${user.username}" id="username" size="20"/></td>
		    			<td class="font3 fftd">状&nbsp;态：<input type="text" name="status" id="status" size="20" value="${user.status}"/></td>
		    		</tr>
		    			
		    		<tr>
		    			<td class="font3 fftd">登录名：<input name="loginname" value="${user.loginname}" id="loginname" size="20" /></td>
