...
<script type="text/javascript">
    ...
    $(function(){
    	...
    	$("#exit").click(function(){
    		...
    		if(confirm("确定要进行注销登录吗？")){
				parent.location = "${ctx}/logout.action";
			}
    	})
		$("#home").click(function () {
			parent.location = "${ctx}/main.action";
		})
	})
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<td class="topbg">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	    <tr>
		  <td height="50" class="toplink" align="right"><img src="${ctx}/images/top_home.gif">&nbsp;&nbsp;<a href="javascript:void(0);" id="home">网站首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="${ctx}/images/top_exit.gif">&nbsp;&nbsp;<a href="javascript:void(0);" id="exit">注销退出</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		</tr>
		<tr>
