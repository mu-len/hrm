...
<html>
	...
	$(function(){
		...
		if(${employee.job.id==null}){
			$("#job_id").val("0");
		}else {
			$("#job_id").val("${employee.job.id}");
		}
		if(${employee.dept.id==null}){
			$("#dept_id").val("0");
		}else {
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${ctx}/hrm_war_exploded/updateEmployees" id="employeeForm" method="post">
			<!-- 隐藏表单，flag表示添加标记 -->
