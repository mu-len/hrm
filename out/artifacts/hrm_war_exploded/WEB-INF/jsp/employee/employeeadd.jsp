	...
	<script type="text/javascript">
	    ...
	    $(function()
	    {
			$("#cardId").blur(function(){
				...
				//异步请求
				$.ajax("${ctx}/hrm_war_exploded/getcardid.action",// 发送请求的URL字符串。
					{
			...
			$("#employeeForm").submit(function(){
				...
				if ($.trim(name.val()) == ""){
					...
					msg = "身份证号码格式不正确！";
					cardId.focus();
				}else if($.trim(sex.val()) == 2){
					msg = "性别不能为空！";
					sex.focus();
				}else if($.trim(job_id.var())==0){
					msg = "职位不能为空！";
					job_id.focus();
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${ctx}/hrm_war_exploded/addEmployee" id="employeeForm" method="post">
		 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			...
		    			<td class="font3 fftd">身份证号码：<input type="text" name="cardId" id="cardId" size="20" /><span id="cardmsgid" style="color:#F00"></span></td>
		    		</tr>
		    		<tr>
			...
			<tr>
				<td class="font3 fftd">
					...
					&nbsp;&nbsp;所属部门：
					<select  name="dept_id" style="width:100px;" id="dept_id">
