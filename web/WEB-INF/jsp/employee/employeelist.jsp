...
<head>
	...
	function toPage(pageIndex)
	{
	    ...
	    $("#empform").attr("action", "${ctx}/hrm_war_exploded/employeelist.action");
		$("#empform").submit();
	}
	   ...
	   $("#checkAll").click(function(){
 	   ...
 	   $("#delete").click(function(){
 		   ...
 		   if(checkedBoxs.length < 1){
			   ...
			   if(confirm("确定要删除已选中的数据吗？")){
				   $("#empform").attr("action", "${ctx}/hrm_war_exploded/employeedel.action");
				   $("#empform").submit();
			   }
 		   }
 	   })
...
<body>
	...
	<form name="empform" method="post" id="empform" action="${ctx}/hrm_war_exploded/employeelists.action">
				...
				<tr id="data_${stat.index}" class="main_trbg" align="center">
					<td><input type="checkbox" id="box_${stat.index}" value="${employee.id}" name="employeeIds"></td>
					 <td>${employee.name }</td>
					  ...
					  <td align="center" width="40px;"><a href="${ctx}/hrm_war_exploded/updateEmployee?flag=1&id=${employee.id}">
