...
<form action="${ctx}/hrm_war_exploded/useraddsave.action" id="userForm" method="post">
  ...
  <tr valign="top">
    <td>
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="submit" value="添加" id="submit">&nbsp;&nbsp;<input type="reset" value="取消 "></td></tr>
		  </table>
	</td>
  </tr>
</table>
